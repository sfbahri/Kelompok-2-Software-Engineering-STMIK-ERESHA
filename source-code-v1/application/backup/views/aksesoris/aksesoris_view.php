...
$(document).ready(function(){
        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    data.push([no,img_qrcode,result[i].nama,result[i].hargas,'<span class="label label-purple">'+result[i].stok_awals+' '+satuan+'</span>','<span class="label label-purple">'+result[i].stok_akhirs+' '+satuan+'</span>',gambar,result[i].tgl,'<div style="width:100%;text-align:center">'+link_edit+'</div>',link_print]);
                }
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <p class="br-section-text"><button class="btn btn-info btn-sm" onclick="getpopup('aksesoris/tambah','<?php echo $this->session->userdata('sess_token');?>','popup_tambah')"><i class="fa fa-plus-circle"></i> Tambah Aksesoris </button></p>
