...
<div class="card col-md-4" style="margin:20px;" id="form_input_no_nota">
<div class="card-body">
    <label>No Nota :</label>
    <div class="d-md-flex pd-y-20 pd-md-y-0">
        <input type="text" readonly="" class="form-control" name="no_nota" id="no_nota" value="<?php echo $tanggal.$token.$token3.$token2;?>">
