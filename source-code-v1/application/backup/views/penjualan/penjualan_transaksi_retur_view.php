        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.id == null){
                    ...
                    $.ajax({
                        url       : base_url + 'penjualan/retur_order_detail',
                        type      : "post",
                        dataType  : 'json',
                        ...
                        success: function (resp) {
                            if(resp == true){
                                $("#kode_produk").val('');
                                Command: toastr["success"]("Produk ini berhasil diretur", "Oke Berhasil");
                                data_order_detail();
                                data_total_order_detail();
                            }else{
...
<div class="br-pageheader">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
      ...
      <span class="breadcrumb-item active">Retur Transaksi Penjualan</span>
    </nav>
</div><!-- br-pageheader -->
<div class="br-pagetitle">
    <i class="icon icon ion-ios-git-compare"></i>
    <div>
      <h4>Retur Transaksi Penjualan</h4>
      <p class="mg-b-0">Halaman retur transaksi penjualan.</p>
    </div>
</div><!-- d-flex -->
