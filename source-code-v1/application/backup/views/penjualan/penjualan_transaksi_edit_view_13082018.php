                    ...
                    $.ajax({
                        ...
                        success: function (data1) {
                            ...
                            for (var i = 0; i < data1.length; i++) {
                                if(res.id_jenis_wilayah_pengiriman == data1[i].i){
                        ...
                        success: function (data2) {
                            ...
                            for (var i = 0; i < data2.length; i++) {
                                if(res.id_jenis_pengiriman == data2[i].id){
                                    $jenis_wilayah.append('<option value=' + data2[i].id + ' selected>' + data2[i].kode + ' - ' + data2[i].nama + '</option>');
                                }else{
                                    $jenis_wilayah.append('<option value=' + data2[i].id + '>' + data2[i].kode + ' - ' + data2[i].nama + '</option>');
                                }
                            }
                        }
                    });
        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    data.push([no,result[i].kode_produk,result[i].hargas,result[i].qty,result[i].hargas,link_hapus]);
            ...
            <div class="col-md-8">
                    ...
                    <hr>
                        ...
                        <div id="form_input_button">
                            ...
                            <button class="btn btn-primary pd-y-13 pd-x-20 bd-0 mg-md-l-10 mg-t-10 mg-md-t-0 tx-uppercase tx-11 tx-spacing-2" id="btn_simpan_warehouse" style="cursor:pointer"><i class="fa fa-save"></i> Update Warehouse</button>
