    ...
    function get_detail_transaksi(){
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $("#no_order_sales").val(res.no_order_sales);
                    ...
                    $("#uang_ongkir").val(res.uangongkir);
                    ...
                    $("#pelanggan_nama_dummy").val(res.nama_dummy);
        ...
        function(){
            ...
            $.ajax({
                ...
                data      : {no_nota            : nonota,
                            ...
                            nama_pelanggan      : $('#pelanggan_nama').val(),
                            nama_pelanggan_dummy: $('#pelanggan_nama_dummy').val(),
                            alamat_pelanggan    : $('#pelanggan_alamat').val(),
                            total               : $('#total_asli').val(),
                            uang_ongkir         : $('#uang_ongkir').val(),
                            no_order_sales      : $('#no_order_sales').val(),
                            <?php echo $this->security->get_csrf_token_name(); ?>:'<?php echo $this->security->get_csrf_hash(); ?>'
                        },
                success: function (response) {
                if(response == true){  
                        swal.close();
                        Command: toastr["success"]("Transaksi berhasil diupdate", "Berhasil");
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <small>No. Order Sales</small>
                        <input type="text" id="no_order_sales" name="no_order_sales" maxlength="30" value="" class="form-control"/>
                        <small>Tanggal</small>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <small>Nama Sementara/Nama Panggilan/Nama Samaran</small>
                        <input type="text" id="pelanggan_nama_dummy" name="pelanggan_nama_dummy" value="" class="form-control"/>
                        <small>Nama Lengkap Pelanggan</small>
                        <input type="text" id="pelanggan_nama" name="pelanggan_nama" value="" class="form-control"/>
                        <small>Telp / HP</small>
                        <input type="text" id="pelanggan_nohp" name="pelanggan_nohp" maxlength="30" value="" class="form-control"/>
                        <small>Email</small>
                        <input type="text" id="pelanggan_email" name="pelanggan_email" value="" class="form-control"/>
                        <small>Alamat</small>
                        <input type="text" id="pelanggan_alamat" name="pelanggan_alamat" value="" class="form-control"/>
                        <hr>
...
<!--                                <button class="btn btn-primary pd-y-13 pd-x-20 bd-0 mg-md-l-10 mg-t-10 mg-md-t-0 tx-uppercase tx-11 tx-spacing-2" id="btn_simpan_transaksi" style="cursor:pointer"><i class="fa fa-save"></i> Update Pembayaran</button>-->
                            ...
                            <button class="btn btn-info pd-y-13 pd-x-20 bd-0 mg-md-l-10 mg-t-10 mg-md-t-0 tx-uppercase tx-11 tx-spacing-2" id="btn_belum_selesai" style="cursor:pointer;display:none"><i class="fa fa-refresh"></i> Ubah Status Transaksi Menjadi Selesai</button>
