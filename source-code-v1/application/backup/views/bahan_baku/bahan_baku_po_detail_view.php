...
$(document).ready(function(){
   ...
   //$("#kategori_bahan").append('<option value="0">- Kategori Bahan -</option><option value="1">Bahan Atasan</option><option value="2">Bahan Bawahan</option><option value="3">Rib</option>');
        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    }else if(result[i].kategori == 3){
                        kategori = 'Rib';
                    }else{
                        kategori = '<span style="color:red">Tidak Ada Kategori</span>';
                    }
                    ...
                    //,result[i].hargas
                    data.push([result[i].noso,result[i].noso+'<span class="tx-11 d-block"><b>QRCODE : '+result[i].kode+'</b></span>',result[i].nama,kategori,result[i].jenis,warna_view,'<span>'+result[i].stok_rol_akhir+' Rol</span>',stok_kilo,'<div style="width:100%;text-align:center">'+link_edit+'</div>',link_print,link_terima]);
                }
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="kategori_bahan" name="kategori_bahan" class="form-control">
                                <option value="0">- Kategori Bahan -</option>
                                <option value="1">Bahan Atasan</option>
                                <option value="2">Bahan Bawahan</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="jumlah_kilo" name="jumlah_kilo" class="form-control clears"><!-- asasas onkeypress="return isNumber(event)"-->
                        </div>
                    </div>
                </div>
