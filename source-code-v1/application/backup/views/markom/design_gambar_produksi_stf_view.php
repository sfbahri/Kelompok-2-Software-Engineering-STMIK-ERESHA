        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                   ...
                   var no = i+1;
                     var link_lihat_gambar = "<a href='javascript:void(0)' onclick=\"getcontents('markom/design_gambar_produksi_upload_stf','"+tokens+"','"+result[i].noso+"');\"><div class='btn btn-info btn-sm' title='Lihat Data Gambar' ><i class='fa fa-file-image-o'></i></div></a>";
