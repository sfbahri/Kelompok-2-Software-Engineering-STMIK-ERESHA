...
margin-bottom: 10px;
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <p class="br-section-text"><button class="btn btn-info btn-sm" onclick="getcontents('markom/design_gambar_produksi_owner','<?php echo $this->session->userdata('sess_token');?>','asa')"><i class="fa fa-refresh"></i> Kembali ke Draft Gambar Produksi</button></p>
