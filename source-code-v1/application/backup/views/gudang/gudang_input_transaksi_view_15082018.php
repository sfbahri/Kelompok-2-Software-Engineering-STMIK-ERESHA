        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    data.push([no,result[i].nama_produks+'<span class="tx-11 d-block"><b>KD_PRODUK : '+result[i].kode_produk+'</b></span>',result[i].nama_produk,result[i].hargas,result[i].qty,result[i].hargas,link_hapus]);
                        ...
                        $.ajax({
                            ...
                            success: function (respz) {
                                if(respz == 0){
                                    ...
                                    $.ajax({
                                        url       : base_url + 'penjualan/input_order_detail_gudang',
                                        type      : "post",
                                        dataType  : 'json',
        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    var link_hapus = "<a href='javascript:void(0)' onclick=\"getpopup('users/module_permission','"+tokens+"','popupedit','"+result[i].nik+"');\"><div class='btn btn-danger btn-sm' title='Batal' ><i class='fa fa-close'></i></div></a>";    
                    data.push([no,result[i].kode_produksi,result[i].nama,img,'<b>'+result[i].qty+'</b>']);
