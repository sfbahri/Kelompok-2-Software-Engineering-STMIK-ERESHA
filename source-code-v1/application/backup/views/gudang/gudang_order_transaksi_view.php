        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    var link_print_inv = '<a href="'+baseurl+'penjualan/cetak_struk_dotmetrik/'+result[i].no_nota+'" target="_blank"><div class="btn btn-success btn-sm" title="Print Invoice" ><i class="fa fa-print"></i></div></a>';
...
//                    
                    data.push([no,'<span style="color:#04ba93;font-weight:bold">'+result[i].no_nota+'</span><span class="tx-11 d-block"><b>KASIR : '+result[i].kasir+'</b></span>',result[i].tgl_order,result[i].nama,result[i].nohp,status,'<span style="color:#04ba93;font-weight:bold">'+result[i].nama_outlet+'</span>',link_edit,link_print,link_print_inv]);
                }
