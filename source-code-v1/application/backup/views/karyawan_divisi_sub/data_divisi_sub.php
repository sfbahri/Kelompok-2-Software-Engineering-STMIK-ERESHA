...
$(document).ready(function(){
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                   ...
                   var no = i+1;
                    ...
                    var link_edit = "<a href='javascript:void(0)' onclick=\"getpopup('divisi_sub/divisi_sub_edit','"+tokens+"','popupedit','"+result[i].id_sub+"');\"><div class='btn btn-info btn-sm' title='Edit Data divisi_sub' ><i class='fa fa-edit'></i></div></a>";    
                   
                    data.push([result[i].nm_sub,result[i].nm_div,link_edit]);
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Data Sub Divisi</span>
        </nav>
    </div><!-- br-pageheader -->
    <div class="br-pagetitle">
        <i class="icon icon ion-ios-people"></i>
        <div>
          <h4>Data Sub Divisi</h4>
          <p class="mg-b-0">Halaman data Sub Divisi.</p>
        </div>
    </div><!-- d-flex -->
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h6 class="br-section-label">Tabel Data Sub Divisi</h6>
            <p class="br-section-text"><button class="btn btn-info btn-sm" onclick="getpopup('divisi_sub/divisi_sub_tambah','<?php echo $this->session->userdata('sess_token');?>','popup_tambah')"><i class="fa fa-plus-circle"></i> Tambah Sub Divisi </button></p>
