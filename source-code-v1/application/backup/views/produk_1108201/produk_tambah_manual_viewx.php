  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Tambah Produk Manual</h4>
      </div>
      <div class="modal-body">
        <form id="form_input"  method=POST enctype='multipart/form-data'>
            ...
            <div class="col-md-12">
                ...
                <input type="text" id="kode_utama" name="kode_utama" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                <label for="demo-vs-definput" class="control-label">Jumlah Label</label>
                <input type="text" id="jumlah_label" name="jumlah_label" class="form-control">
                </div>
