...
$(document).ready(function(){
    ...
    $.ajax({
            ...
            success: function (response) {
             ...
             $("#stok").val(response.stok+' Pcs');
             $("#hargas").val(response.hargas);
             $("#harga_diskon").val(response.harga_diskon);
        },
    ...
    $("#btn_simpan_produksi").click(function(){
        ...
        function(){
            ...
            $.ajax({
                url             : base_url + 'produk/update_manual', 
                type            : "POST",
                dataType        : 'json',
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content ">
        <div class="modal-header pd-y-20 pd-x-25">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Kelola Produk</h6>
            ...
            <div class="row">
                ...
                <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="kode_utama" name="kode_utama" class="form-control" readonly value="<?php echo $id_row;?>">
                        </div>
                        <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-4">
                             <label for="demo-vs-definput" class="control-label">Sisa Stok</label>
                            <input type="text" id="stok" name="stok" class="form-control" readonly>
                        </div>
                        <div class="col-md-4">
                            <label for="demo-vs-definput" class="control-label">Harga</label>
                            <input type="text" id="hargas" name="hargas" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label for="demo-vs-definput" class="control-label">Harga Diskon</label>
                            <input type="text" id="harga_diskon" name="harga_diskon" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
