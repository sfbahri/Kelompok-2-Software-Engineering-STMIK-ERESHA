            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <div class="row">
                      <div class="col-md-4">
                          ...
                          <input type="text" id="small_warna_1_inisial" name="small_warna_1_inisial" class="form-control small_warna_1_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
                ...
                <div class="col-md-4">
                  ...
                  <div class="row">
                      <div class="col-md-4">
                          <label for="demo-vs-definput" class="control-label">INS. Warna</label>
                          <input type="text" id="small_warna_2_inisial" name="small_warna_2_inisial" class="form-control small_warna_2_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
                ...
                <div class="col-md-4">
                  ...
                  <div class="row">
                      <div class="col-md-4">
                          <label for="demo-vs-definput" class="control-label">INS. Warna</label>
                          <input type="text" id="small_warna_3_jumlah" name="small_warna_3_inisial" class="form-control small_warna_3_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="row">
                      <div class="col-md-4">
                          <label for="demo-vs-definput" class="control-label">INS. Warna</label>
                          <input type="text" id="medium_warna_1_inisial" name="medium_warna_1_inisial" class="form-control medium_warna_1_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
                ...
                <div class="col-md-4">
                  ...
                  <div class="row">
                      <div class="col-md-4">
                          <label for="demo-vs-definput" class="control-label">INS. Warna</label>
                          <input type="text" id="medium_warna_2_inisial" name="medium_warna_2_inisial" class="form-control medium_warna_2_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
                ...
                <div class="col-md-4">
                  ...
                  <div class="row">
                      <div class="col-md-4">
                          <label for="demo-vs-definput" class="control-label">INS. Warna</label>
                          <input type="text" id="medium_warna_3_jumlah" name="medium_warna_3_inisial" class="form-control medium_warna_3_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="row">
                      <div class="col-md-4">
                          <label for="demo-vs-definput" class="control-label">INS. Warna</label>
                          <input type="text" id="large_warna_1_inisial" name="large_warna_1_inisial" class="form-control large_warna_1_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="row">
                      <div class="col-md-4">
                          <label for="demo-vs-definput" class="control-label">INS. Warna</label>
                          <input type="text" id="large_warna_2_inisial" name="large_warna_2_inisial" class="form-control large_warna_2_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="row">
                      <div class="col-md-4">
                          <label for="demo-vs-definput" class="control-label">INS. Warna</label>
                          <input type="text" id="large_warna_3_inisial" name="large_warna_3_inisial" class="form-control large_warna_3_inisial" maxlength="6">
                      </div>
                      <div class="col-md-8">
                          <div class="form-group">
