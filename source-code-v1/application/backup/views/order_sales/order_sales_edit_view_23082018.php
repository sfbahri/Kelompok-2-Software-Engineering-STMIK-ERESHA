...
$(document).ready(function(){
    ...
    function data_order_sales(){
        ...
        $.ajax({
            type: 'POST',
            url: base_url + 'order_sales/detail',
            ...
            success: function (ref) {
                ...
                $("#ongkos_kirim").val(ref.ongkos_kirim);
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                   ...
                   var no = i+1;
                    ...
                    data.push([img,result[i].nama_produk,result[i].stok+' Pcs',input_request,catatan,btn_order]);
...
<div class="modal fade" id="<?php echo $id_modal;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header pd-y-20 pd-x-25">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">EDIT ORDER SALES NO. <span id="no_os_text" style="color:red"></span></h6>
