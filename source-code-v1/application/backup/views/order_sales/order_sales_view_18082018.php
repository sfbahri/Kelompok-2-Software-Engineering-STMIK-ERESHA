...
$(document).ready(function(){
        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    var link_print_inv = '<a href="'+baseurl+'order_sales/cetak_struk_dotmetrik_unpaid/'+result[i].noos+'" target="_blank"><div class="btn btn-success btn-sm" title="Print Order Sales" ><i class="fa fa-print"></i></div></a>';
                    
                    data.push([no,result[i].noos,result[i].nama_pelanggan,result[i].kategori_status,result[i].nonota,result[i].nama_karyawan,result[i].created_at,'<div style="width:100%;text-align:center">'+link_edit+'</div>',btn_HPS,link_print_inv]);
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <table id="tabel_order_sales" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th>No</th>
