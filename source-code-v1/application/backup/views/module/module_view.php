...
$(document).ready(function(){
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    if(result[i].position == 1 && result[i].have_child == 'Y'){
                        link_edit  = "<a href='javascript:void(0)' onclick=\"getpopup('module/edit','"+tokens+"','popupedit','"+result[i].id+"');\"><span class='btn btn-info btn-sm fa fa-plus' title='Tambah Modul Sub'></span></a>";
                    }else{
                        link_edit  = "";
                    }
                    ...
                    data.push([no,result[i].id,result[i].name,result[i].icon,result[i].controller,position,result[i].have_child,result[i].parent,result[i].sequence,link_edit,link_hapus]);
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <table id="tabel_module" class="table table-responsive">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Id Modul</th>
