...
$(document).ready(function(){
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                   ...
                   var no = i+1;
                    ...
                    var link_edit = "<a href='javascript:void(0)' onclick=\"getpopup('jabatan/jabatan_edit','"+tokens+"','popupedit','"+result[i].id+"');\"><div class='btn btn-info btn-sm' title='Edit Data jabatan' ><i class='fa fa-edit'></i></div></a>";    
    ...
    <div class="br-pagetitle">
        ...
        <div>
          <h4>Data jabatan</h4>
          <p class="mg-b-0">Halaman data jabatan.</p>
        </div>
    </div><!-- d-flex -->
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h6 class="br-section-label">Tabel Data jabatan</h6>
            <p class="br-section-text"><button class="btn btn-info btn-sm" onclick="getpopup('jabatan/jabatan_tambah','<?php echo $this->session->userdata('sess_token');?>','popup_tambah')"><i class="fa fa-plus-circle"></i> Tambah jabatan </button></p>
