...
$(document).ready(function(){
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                   ...
                   var no = i+1;
                    ...
                    var link_edit = "<a href='javascript:void(0)' onclick=\"getpopup('sewing/detail','"+tokens+"','popupedit','"+result[i].id+"');\"><div class='btn btn-info' title='Detail Cutting' ><i class='ft-edit'></i></div></a>";
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Proses Sewing</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Proses Sewing</a></li>
                        <li class="breadcrumb-item active">Data Sewing</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card-header">
                  <h4 class="card-title">Data Sewing</h4>
