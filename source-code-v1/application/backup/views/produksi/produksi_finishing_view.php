...
//        $.ajax({
//        url       : base_url + 'produksi/data_detail_finishing',
//        type      : "post",
//        dataType  : 'json',
//        async     : false,
//        data      : {kode_produksi  : kode_produksi,
...
//        });
    ...
    $.ajax({
        ...
        success: function (response) {
            $('#tgl_serah_terima').val(response.tgl_serahterima);
            ...
            if(response.jumlah == 0){
                ...
                $('#jumlah_akhir_finishing').val(response.jumlah_finishing);
            }
            ...
            //inisial produk
            get_detail_warna_finishing('small_warna_1_inisial_akhir',response.S1_inisial);
            get_detail_warna_finishing('small_warna_2_inisial_akhir',response.S2_inisial);
            get_detail_warna_finishing('large_warna_1_inisial_akhir',response.L1_inisial);
            get_detail_warna_finishing('large_warna_2_inisial_akhir',response.L2_inisial);
//            $('#small_warna_1_inisial_akhir').val(response.S1_inisial);
//            $('#small_warna_2_inisial_akhir').val(response.S2_inisial);
//            $('#large_warna_1_inisial_akhir').val(response.L1_inisial);
//            $('#large_warna_2_inisial_akhir').val(response.L2_inisial);
            
            
            //jumlah produksi
            $('#small_warna_1_jumlah_akhir').val(response.S1_jumlah);
            $('#small_warna_2_jumlah_akhir').val(response.S2_jumlah);
            $('#large_warna_1_jumlah_akhir').val(response.L1_jumlah);
            $('#large_warna_2_jumlah_akhir').val(response.L2_jumlah);
            
            
            if(response.stok_at == null){
    ...
    get_detail_warna_finishing = function(nama_select,id_warna){
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#"+nama_select).empty();
                var $jenis_wilayah = $("#"+nama_select);
                //$jenis_wilayah.append('<option value=0>- Pilih Warna -</option>');
                for (var i = 0; i < data.length; i++) {
                    if(data[i].id == id_warna){
                        $jenis_wilayah.append('<option value=' + data[i].id + ' selected>' + data[i].inisial + ' - ' + data[i].nama + '</option>');
                    }else{
                        $jenis_wilayah.append('<option value=' + data[i].id + '>' + data[i].inisial + ' - ' + data[i].nama + '</option>');
                    }
                }
                $("#"+nama_select).chosen({width: "100%"});
                $("#"+nama_select).attr('readonly',true).trigger('chosen:updated');
            }
        });
    }
    ...
    $("#btn_selesai_finishing").click(function(){
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
                <div class="col-md-8">
                    <label for="demo-vs-definput" class="control-label">Warna 1(S)</label>
                    <select class="form-control small_warna_1_inisial_akhir"  id="small_warna_1_inisial_akhir" name="small_warna_1_inisial_akhir"></select>
<!--                    <input type="text" id="small_warna_1_inisial_akhir" name="small_warna_1_inisial_akhir" class="form-control small_warna_1_inisial" maxlength="2">-->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="date2">Jumlah W1 (S)</label>
                        <input type="text" id="small_warna_1_jumlah_akhir" name="small_warna_1_jumlah_akhir" class="form-control read_only" placeholder="Jumlah">
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-8">
                    <label for="demo-vs-definput" class="control-label">Warna 2(S)</label>
                    <select class="form-control small_warna_2_inisial_akhir"  id="small_warna_2_inisial_akhir" name="small_warna_2_inisial_akhir"></select>
<!--                    <input type="text" id="small_warna_2_inisial_akhir" name="small_warna_2_inisial_akhir" class="form-control small_warna_2_inisial" maxlength="2">-->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="date2">Jumlah W2 (S)</label>
                        <input type="text" id="small_warna_2_jumlah_akhir" name="small_warna_2_jumlah_akhir" class="form-control read_only" placeholder="Jumlah">
                    </div>
                </div>
            </div>  
          </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
                <div class="col-md-8">
                    <label for="demo-vs-definput" class="control-label">Warna 1(L)</label>
                    <select class="form-control large_warna_1_inisial_akhir"  id="large_warna_1_inisial_akhir" readonly name="large_warna_1_inisial_akhir"></select>
<!--                    <input type="text" id="large_warna_1_inisial_akhir" name="large_warna_1_inisial_akhir" class="form-control large_warna_1_inisial" maxlength="2">-->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="date2">Jumlah W1 (L)</label>
                        <input type="text" id="large_warna_1_jumlah_akhir" name="large_warna_1_jumlah_akhir" class="form-control read_only" placeholder="Jumlah">
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="row">
                <div class="col-md-8">
                    <label for="demo-vs-definput" class="control-label">Warna 2(L)</label>
                    <select class="form-control large_warna_2_inisial_akhir"  id="large_warna_2_inisial_akhir" name="large_warna_2_inisial_akhir"></select>
<!--                    <input type="text" id="large_warna_2_inisial_akhir" name="large_warna_2_inisial_akhir" class="form-control large_warna_2_inisial" maxlength="2">-->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="date2">Jumlah W2 (L)</label>
                        <input type="text" id="large_warna_2_jumlah_akhir" name="large_warna_2_jumlah_akhir" class="form-control read_only" placeholder="Jumlah">
                    </div>
                </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <a href="<?php echo base_url('cetak/cetak_produksi_finishing/'.$id_row);?>" target="_blank" ><button type="button" id="btn_cetak_finishing" style="margin-right: 2px" class="btn btn-info pull-right"><i class="fa fa-print"></i> Cetak </button></a>
