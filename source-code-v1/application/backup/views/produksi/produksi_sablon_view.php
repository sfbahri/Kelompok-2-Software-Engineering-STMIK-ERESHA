...
$(document).ready(function(){
    ...
    select_vendor_sablon = function(id){
        ...
        $.ajax({
            ...
            success: function (response) {
                    $("#vendor_sablon").empty();
                    $('#vendor_sablon').append('<option value="0">- Pilih Vendor -</option>');
                    for ( var i=0 ; i<response.length ; i++ ) {
                        var ids = response[i].id;
                        if(id == ids){
                            $("#vendor_sablon").append('<option value="'+response[i].id+'" selected>'+response[i].nama+'</option>');
                        }else{
                            $("#vendor_sablon").append('<option value="'+response[i].id+'">'+response[i].nama+'</option>');
                        }
                    }
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="vendor_sablon" id="vendor_sablon" class="form-control"> </select>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
