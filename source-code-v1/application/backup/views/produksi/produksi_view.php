...
//                                      +'</span>';
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <p class="br-section-text"><button class="btn btn-info btn-sm" onclick="getpopup('produksi/tambah','<?php echo $this->session->userdata('sess_token');?>','popup_tambah')"><i class="fa fa-plus-circle"></i> Tambah Produksi </button> </p>
<!--                <button class="btn btn-warning btn-sm" onclick="getpopup('produksi/tambah_manual','<?php echo $this->session->userdata('sess_token');?>','popup_tambah')"><i class="fa fa-plus-circle"></i> Tambah Manual Produksi </button>-->
