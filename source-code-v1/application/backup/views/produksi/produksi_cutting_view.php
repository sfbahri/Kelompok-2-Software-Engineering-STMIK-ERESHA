...
$(document).ready(function(){
    ...
    get_produksi_details = function(){
        ...
        success: function (res) {
            ...
            get_detail_warna('small_warna_1_inisial',res.small_warna_1_inisial);
            get_detail_warna('small_warna_2_inisial',res.small_warna_2_inisial);
            get_detail_warna('large_warna_1_inisial',res.large_warna_1_inisial);
            get_detail_warna('large_warna_2_inisial',res.large_warna_2_inisial);
           
            if(res.stok_status == 1){
               // $('#yourSelect').prop('disabled', true);
                $('.small_warna_1_inisial').prop('disabled', true);
                $('.small_warna_1_jumlah').attr('readonly', true);
                $('.small_warna_2_inisial').prop('disabled', true);
                $('.small_warna_2_jumlah').attr('readonly', true);
                $('.large_warna_1_inisial').prop('disabled', true);
                $('.large_warna_1_jumlah').attr('readonly', true);
                $('.large_warna_2_inisial').prop('disabled', true);
    ...
    get_detail_warna = function(nama_select,id_warna){
        $.ajax({
            type: 'POST',
    ...
    select_vendor = function(id){
        $.ajax({
            ...
            success: function (response) {
                    ...
                    $('#vendor_cutting').append('<option value="0">- Pilih Vendor -</option>');
                    ...
                    $("#vendor_cutting").chosen({width: "100%"});
            },
            error: function(jqXHR, textStatus, errorThrown) {
                Command: toastr["error"]("Ajax Error !!", "Error");
            }
          ...
          <div class="col-md-6">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <select class="form-control select_warna small_warna_1_inisial"  id="small_warna_1_inisial" name="small_warna_1_inisial"></select>
          ...
          <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <select class="form-control select_warna small_warna_2_inisial"  id="small_warna_2_inisial" name="small_warna_2_inisial"></select>
          ...
          <div class="col-md-6">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <select class="form-control select_warna large_warna_1_inisial"  id="large_warna_1_inisial" name="large_warna_1_inisial"></select>
          ...
          <div class="col-md-6">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <select class="form-control select_warna large_warna_2_inisial"  id="large_warna_2_inisial" name="large_warna_2_inisial"></select>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="jumlah_akhir_cutting" name="jumlah_akhir_cutting" class="form-control large_warna_2_jumlah">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
