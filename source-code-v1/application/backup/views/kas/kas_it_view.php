...
$(document).ready(function(){
    ...
    var data_kas_it = function(){
        
        $.ajax({ 
            url: base_url + 'kas/get_data_kas_it',
            type: "post",
    ...
    $("#btn_simpan").click(function(){
        ...
        function(){
            ...
            $.ajax({
                url       : base_url + 'kas/kas_it_simpan',
                type      : "post",
                dataType  : 'json',
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Data Kas IT</span>
        </nav>
    ...
    <div class="br-pagetitle">
        ...
        <div>
          <h4>Kas IT</h4>
          <p class="mg-b-0">Halaman data kas it.</p>
        </div>
        <div class="">
        ...
        <div class="br-section-wrapper">
            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                    <div class="card">
                    <div class="card-header tx-medium bd-0 tx-white bg-info">Form Input Kas IT</div>
                    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="card">
                <div class="card-header tx-medium bd-0 tx-white bg-info">Data Kas IT</div>
                <div class="card-body card-dashboard">
                    
                    <table id="tabel_kas_it" class="table table-striped table-bordered table-responsive" style="width: 100%">
                            <thead>
                                <tr>
