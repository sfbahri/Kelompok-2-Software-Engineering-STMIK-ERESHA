...
$(document).ready(function(){
    ...
    var data_kas_kecil = function(){
        
        $.ajax({ 
            url: base_url + 'kas/get_data_kas_pickup',
            type: "post",
    ...
    $("#btn_simpan").click(function(){
        ...
        swal({
            title: "Simpan Data ini Ke Kas Pickup ?",
        ...
        function(){
            ...
            $.ajax({
                url       : base_url + 'kas/kas_pickup_simpan',
                type      : "post",
                dataType  : 'json',
                ...
                success: function (response) {
                    if(response == true){
                        swal.close();
                        Command: toastr["success"]("Data Berhasil disimpan ke Kas Pickup", "Berhasil");
                        data_kas_kecil();
                        $("#nominal").val('');
                        $("#tanggal").val('');
                        $("#catatan").val('');
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Data Kas Pickup</span>
        </nav>
    ...
    <div class="br-pagetitle">
        ...
        <div>
          <h4>Kas Pickup</h4>
          <p class="mg-b-0">Halaman data kas pickup.</p>
        </div>
        <div class="">
        ...
        <div class="br-section-wrapper">
            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                    <div class="card">
                    <div class="card-header tx-medium bd-0 tx-white bg-info">Form Input Kas Pickup</div>
                    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="card">
                <div class="card-header tx-medium bd-0 tx-white bg-info">Data Kas Pickup</div>
                <div class="card-body card-dashboard">
                    
                    <table id="tabel_kas_pickup" class="table table-striped table-bordered table-responsive" style="width: 100%">
                            <thead>
                                <tr>
