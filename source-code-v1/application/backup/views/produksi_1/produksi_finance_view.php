        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    var link_input_harga  = "<a href='javascript:void(0)' onclick=\"getpopup('produksi/input_harga','"+tokens+"','popupedit','"+result[i].kode+"','"+result[i].status+"');\" data-placement='top' ><div class='btn btn-info btn-sm btn-icon la la-edit' title='Input Harga Dasar' ></div></a>";
...
//                                      +'</span>';
                    ...
                    data.push([img_qrcode,img,result[i].nama,result[i].tgl_mulai,link_input_harga]);
                }
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Input Harga Dasar</h3>
