...
$(document).ready(function(){
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                   ...
                   var no = i+1;
                    ...
                    var link_edit = "<a href='javascript:void(0)' onclick=\"getpopup('divisi/divisi_edit','"+tokens+"','popupedit','"+result[i].id+"');\"><div class='btn btn-info btn-sm' title='Edit Data divisi' ><i class='fa fa-edit'></i></div></a>";    
                   
                    data.push([result[i].nama,link_edit]);
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Data Divisi</span>
        </nav>
    </div><!-- br-pageheader -->
    <div class="br-pagetitle">
        ...
        <div>
          <h4>Data Divisi</h4>
          <p class="mg-b-0">Halaman data divisi.</p>
        </div>
    </div><!-- d-flex -->
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h6 class="br-section-label">Tabel Data divisi</h6>
            <p class="br-section-text"><button class="btn btn-info btn-sm" onclick="getpopup('divisi/divisi_tambah','<?php echo $this->session->userdata('sess_token');?>','popup_tambah')"><i class="fa fa-plus-circle"></i> Tambah Divisi </button></p>
