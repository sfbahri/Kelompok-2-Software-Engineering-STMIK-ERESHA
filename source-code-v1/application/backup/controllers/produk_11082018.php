...
class Produk extends CI_Controller {
    ...
    public function simpan_manual(){
        ...
        for ($x = 0; $x < $small_jumlah_1; $x++) {
            ...
            $kode_produk = 'S1'.$kd_produksi.$small_inisial_1.$no;
            /*Start Qr Code*/
            $this->load->library('ciqrcode'); //pemanggilan library QR CODE
            ...
            $inisial = 'S1'.$token_small_1.$this->input->post('kode_produksi',TRUE);
            
            $this->produk_model->created_label($img_qrcode,$harga_jual,$kd_produksi,$kode_produk,$inisial,$nama);
        ...
        for ($x = 0; $x < $small_jumlah_2; $x++) {
            ...
            $kode_produk = 'S2'.$kd_produksi.$small_inisial_2.$no;
            /*Start Qr Code*/
            $this->load->library('ciqrcode'); //pemanggilan library QR CODE
            ...
            $inisial = 'S2'.$token_small_2.$this->input->post('kode_produksi',TRUE);
        ...
        for ($x = 0; $x < $small_jumlah_3; $x++) {
            ...
            $no = $x + 1;
            //$kode_produksi_produk = 'S'.$kd_produksi.$small_inisial_2.$no;
            $kode_produksi_produk = 'S3'.$kd_produksi.$small_inisial_3.$no;
            /*Start Qr Code*/
            $this->load->library('ciqrcode'); //pemanggilan library QR CODE
            ...
            $inisial = 'S3'.$token_small_2.$this->input->post('kode_produksi',TRUE);
            
            $this->produk_model->created_label($img_qrcode,$harga_jual,$kd_produksi,$kode_produksi_produk,$inisial,$nama);
        ...
        for ($x = 0; $x < $medium_jumlah_1; $x++) {
            ...
            $no = $x + 1;
            //$kode_produksi_produk = 'S'.$kd_produksi.$small_inisial_1.$no;
            $kode_produksi_produk = 'M1'.$kd_produksi.$medium_inisial_1.$no;
            /*Start Qr Code*/
            $this->load->library('ciqrcode'); //pemanggilan library QR CODE
            ...
            $inisial = 'M1'.$token_medium_1.$this->input->post('kode_produksi',TRUE);
        ...
        for ($x = 0; $x < $medium_jumlah_2; $x++) {
            ...
            $no = $x + 1;
            //$kode_produksi_produk = 'S'.$kd_produksi.$small_inisial_1.$no;
            $kode_produksi_produk = 'M2'.$kd_produksi.$medium_inisial_2.$no;
            /*Start Qr Code*/
            $this->load->library('ciqrcode'); //pemanggilan library QR CODE
            ...
            $inisial = 'M2'.$token_medium_1.$this->input->post('kode_produksi',TRUE);
        ...
        for ($x = 0; $x < $medium_jumlah_3; $x++) {
            ...
            $no = $x + 1;
            //$kode_produksi_produk = 'S'.$kd_produksi.$small_inisial_1.$no;
            $kode_produksi_produk = 'M3'.$kd_produksi.$medium_inisial_3.$no;
            /*Start Qr Code*/
            $this->load->library('ciqrcode'); //pemanggilan library QR CODE
            ...
            $inisial = 'M3'.$token_medium_1.$this->input->post('kode_produksi',TRUE);
        ...
        for ($x = 0; $x < $large_jumlah_1; $x++) {
            ...
            $inisial = 'L1'.$token_large_1.$this->input->post('kode_produksi',TRUE);
        ...
        for ($x = 0; $x < $large_jumlah_2; $x++) {
            ...
            $inisial = 'L2'.$token_large_2.$this->input->post('kode_produksi',TRUE);
        ...
        for ($x = 0; $x < $large_jumlah_3; $x++) {
            ...
            $no = $x + 1;
            //$kode_produksi_produk = 'L'.$kd_produksi.$large_inisial_2.$no;
            $kode_produksi_produk = 'L3'.$kd_produksi.$large_inisial_3.$no;
            /*Start Qr Code*/
            $this->load->library('ciqrcode'); //pemanggilan library QR CODE
            ...
            $inisial = 'L3'.$token_large_3.$this->input->post('kode_produksi',TRUE);
