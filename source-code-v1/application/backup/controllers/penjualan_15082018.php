...
class Penjualan extends CI_Controller {
    ...
    public function cetak_struk_dotmetrik($no_nota){
            ...
            $html = '<table width="100%" border="0" style="margin-right:20px;margin-left:20px;">
                    <tr>
                      <td height="53" colspan="5"><strong>STRUK PEMBELIAN - BABYNEEDS.CO.ID</strong> <br> Ruko Allogio Barat No.9, Medang, Pagedangan, Tangerang, Banten 15334 <br> <img src="'.base_url('/uploads/qrcode/'.$imgqrcode.'').'" width="50px" height="50px"></td>
                    </tr>
                    <tr>
