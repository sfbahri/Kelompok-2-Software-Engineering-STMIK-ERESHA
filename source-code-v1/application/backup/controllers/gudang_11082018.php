...
class Gudang extends CI_Controller {
    ...
    public function cetak_resi_pdf($kode){
        ...
        $resi = $this->gudang_model->data_resi($kode)->result_array();
...
font-family: 'Tahoma, Geneva, sans-serif';
        ...
        <!DOCTYPE html>
            ...
            foreach ($resi as $value) {
                //<div class='fontss' style='font-size:12px;margin:10px;font-family: 'Tahoma, Geneva, sans-serif';font-weight:bold'>ADM-KSR : <b>".strtoupper($value[kasir])."</b> / TGL-ORD : ".$value[tgl_kirim]."</div>
            echo "<body>  
                <br>
                <div id='container'>
                ...
                <hr>
                <div class='fontss' style='font-size:15px;margin:10px;font-family: 'Tahoma, Geneva, sans-serif';font-weight:bold'><b>NO. NOTA : ".$value[no_nota]."<b> <br> <div style='font-size:10px'>ADM-KSR : <b>".strtoupper($value[kasir])."</b> / TGL-ORD : ".$value[tgl_kirim]." / <br> CTK : ".date("Y-m-d h:i")."</div></div>
                <hr>
                ...
                echo "  <div class='fontss' style='font-size:11px;margin:10px;font-family: 'Tahoma, Geneva, sans-serif';font-weight:bold'><b>INFORMASI PEMESAN :</b></div>
                        ...
                        <tr><td>No. HP</td><td>&nbsp;: $value[nohp]</td></tr>
                        <tr><td>Kurir</td><td>&nbsp;: $value[nmjk]</td></tr>
                        <tr><td>Kode</td><td>&nbsp;: <b>$value[kjp] - $value[no_nota]</b></td></tr>
                        <tr><td colspan='2' align='center'><img class='qr' src='". base_url()."uploads/qrcode/$value[img_qrcode]' style='width:120px;height:120px'/></td></tr>
                        </table>";
                }
