...
class Penjualan extends CI_Controller {
    ...
    public function cetak_struk_dotmetrik($no_nota){
            ...
            $html = '<table width="100" border="0" style="margin-right:20px;margin-left:20px;">
                    <tr>
                      <td height="53" colspan="3" align="left"><strong>STRUK PEMBELIAN - BABYNEEDS.CO.ID</strong> <br> Ruko Allogio Barat No.9, Medang, Pagedangan, Tangerang, Banten 15334</td>
                    </tr>
                    <tr>
                      <td height="53" colspan="3" align="left"><strong>INFORMASI PEMBELI</strong> <br> '.$d['nama'].' / '.$d['nama_dummy'].' / '.$d['nohp'].' / '.$d['alamat'].'</td>
                    </tr>
                    <tr>
                    <td colspan="3" align="left">No Nota : <b>'.$no_nota.' / ADM : '.$d['kasir'].' / CTK : '.date("Y-m-d h:i").'</b></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      <td colspan="5" align="center"><b>BCA : 3366772999 </b> a/n Desy Tanzil / Willy Septian Alexander </td>
                    </tr>
                    <tr>
                      <td colspan="5" align="center"><b>Mandiri : 1210 04 09 1988 </b> a/n Willy Septian Alexander</td>
                    </tr>
                    <tr>
            ...
            //$html = $this->load->view('produksi/produksi_print_label_view',$data);
            //$mpdf = new mPDF('utf-8', array(95,122.27),'0');         
            $mpdf = new mPDF('utf-8', array(125,81), 8, '', '', '', '', '', '', '');
