...
class Main_model extends CI_Model{	
    ...
    function check_token_main($token,$nik){
         $sql = "SELECT * FROM users WHERE token = '$token' and nik = '$nik' and is_deleted = '0' and aktif = '1'";
    ...
    function check_passusertoken($token,$nik,$aktif){
