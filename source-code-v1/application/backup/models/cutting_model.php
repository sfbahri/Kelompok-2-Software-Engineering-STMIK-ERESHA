...
class Cutting_model extends CI_Model{	
    ...
    function update($data,$nama_file){
        ...
        $sql = "UPDATE  produksi_cutting SET    tgl_mulai        = $tgl_mulai
                                                ...
                                                gambar           = '$nama_file',
                                                biaya            = '$biaya_cutting',
                                                warna_1_S        = '$data[small_warna_1_inisial]',
                                                warna_2_S        = '$data[small_warna_2_inisial]',
                                                warna_1_L        = '$data[small_warna_1_inisial]',
                                                warna_2_L        = '$data[small_warna_2_inisial]',
                                                jumlah_1_S       = '$data[small_warna_1_jumlah]',
                                                jumlah_2_S       = '$data[small_warna_2_jumlah]',
                                                jumlah_1_L       = '$data[large_warna_1_jumlah]',
                                                jumlah_2_L       = '$data[large_warna_2_jumlah]',
                                                updated_by       = '$user_nik',
        ...
        $sql3 = "UPDATE  produk_header SET   S1_inisial = '$data[small_warna_1_inisial]',
                                            S2_inisial = '$data[small_warna_2_inisial]',
                                            L1_inisial = '$data[large_warna_1_inisial]',
                                            L2_inisial = '$data[large_warna_2_inisial]',
                                            updated_by            = '$user_nik',
                                            updated_at            = NOW() WHERE kode_produksi = '$data[kode_produksi]'";
        $this->db->query($sql3);
