...
class Finishing_model extends CI_Model{	
    ...
    function update($data,$nama_file){
        ...
        $sql = "UPDATE  produksi_finishing SET      tgl_serah_terima = $tgl_serah_terima
                                                    ...
                                                    jumlah_s_1       = '$data[small_warna_1_jumlah_akhir]',
                                                    jumlah_s_2       = '$data[small_warna_2_jumlah_akhir]',
                                                    jumlah_l_1       = '$data[large_warna_1_jumlah_akhir]',
                                                    jumlah_l_2       = '$data[large_warna_2_jumlah_akhir]',
                                                    warna_s_1        = '$data[small_warna_1_inisial_akhir]',
                                                    warna_s_2        = '$data[small_warna_2_inisial_akhir]',
                                                    warna_l_1        = '$data[large_warna_1_inisial_akhir]',
                                                    warna_l_2        = '$data[large_warna_2_inisial_akhir]',
                                                    gambar           = '$nama_file',
                                                    updated_by       = '$user_nik',
    ...
    function created_label($img_qrcode,$kode_produksi,$kode_produksi_produk,$inisial,$data){
