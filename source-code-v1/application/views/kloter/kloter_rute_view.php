        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    var link_edit = "<a href='javascript:void(0)' onclick=\"detail_kloter_rute('"+result[i].id_kloter+"','"+result[i].id+"');\"><div class='btn btn-info btn-sm' title='Edit' ><i class='fa fa-pencil'></i></div></a>";    
                    ...
                    //,result[i].jam
                    data.push([no,result[i].dari,result[i].ke,link_edit,link_hapus]);
      ...
      <div class="modal-body">
          <div class="row">  
            <div class="col-md-3" style="padding-right:0px">
                ...
                <input type="text" id="dari" name="dari" class="form-control clear_edit_rute uppercase" placeholder="Dari Mana ?">
              ...
              <div class="col-md-3" style="padding-right:0px">
                ...
                <label for="demo-vs-definput" class="control-label">Ke</label>
                    <input type="text" id="kemana" name="kemana" class="form-control clear_edit_rute uppercase" placeholder="Ke Mana ?">
                </div>
            </div>
<!--            <div class="col-md-3">
                <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-info" id="btn_simpan" title="Simpan"><i class="fa fa-save"></i></button>
                    <button type="button" class="btn btn-success" id="btn_simpan2" style="display:none" title="Update & Simpan"><i class="fa fa-save"></i></button>
                    <button type="button" class="btn btn-danger" id="btn_simpan3" style="display:none" title="Batal"><i class="fa fa-close"></i></button>
                </div>
            </div>
