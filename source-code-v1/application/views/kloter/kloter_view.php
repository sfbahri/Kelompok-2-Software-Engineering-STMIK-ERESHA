        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    ...
                    var link_rute = "<div style='text-align:center'><a href='javascript:void(0)' onclick=\"getpopup('kloter/rute','"+tokens+"','popupedit','"+result[i].id+"');\"><div class='btn btn-success btn-sm' title='Rute' ><i class='fa fa-plane'></i></div></a></div>";
                    ...
                    data.push([no,result[i].nama,link_rute,link_jamaah,link_edit,link_hapus]);
