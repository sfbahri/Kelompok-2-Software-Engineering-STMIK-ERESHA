...
$(document).ready(function(){
    ...
    var id_klien       = '<?php echo $id_row;?>';
   
    loading();
   
   
    $("#id_klien").val(id_klien);
   
    $.ajax({
        url       : base_url + 'klien/detail',
        type      : "post",
        dataType  : 'json',
        ...
        success: function (response) {
            ...
            var gambar = '<div style="width:100%;text-align:left"><img src="./uploads/img_klien/rz_'+response.gambar+'" style="width:100px;height:100px"></div>';
            ...
            $.ajax({
                ...
                success     : function(response){
                    if(response == true){
                        $('#'+id_modal).modal('hide');   
                        swal.close();
                        Command: toastr["success"]("Klien berhasil diupdate", "Berhasil");
            ...
            $.ajax({
                ...
                success: function (response) {
                    if(response == true){
                            $('#'+id_modal).modal('hide');   
                            swal.close();
                            Command: toastr["success"]("Klien berhasil dihapus", "Berhasil");
                            getcontents('klien','<?php echo $tokens;?>');
                    }else{
                        Command: toastr["error"]("Simpan error, data tidak berhasil disimpan", "Error");
                    } 
...
<div class="modal fade" id="<?php echo $id_modal;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header pd-y-20 pd-x-25">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Edit Klien</h6>
        ...
        <div class="modal-body">
            ...
            <input type="hidden" id="id_klien" name="id_klien" class="form-control">
