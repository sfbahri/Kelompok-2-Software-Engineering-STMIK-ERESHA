...
$(document).ready(function(){
	...
	// ====================== Start : Upload Dropzone ==================== //
	    ...
	    url: "<?php echo base_url('slider/proses_upload_media2') ?>",
	    maxFilesize: 5,
	    method:"post",
...
//	            });
        ...
        success: function (res) {
            ...
            for ( var i=0 ; i<res.length ; i++ ) {
                ...
                var html = '<div class="col-md-12" style="float:left;margin-bottom:30px"><div class="card" >'
                        html+='<figure class="overlay"><img class="card-img-top img-fluid" src="./uploads/img_slider/'+res[i].gambar+'" alt="Image" class="img-fluid" style="width:100%"><figcaption class="overlay-body d-flex align-items-end justify-content-center">'
                                html+='<div class="img-option">'
                                  ...
                                  html+='<a href="./uploads/img_slider/'+res[i].gambar+'" title="Lihat Lebih Jelas" target="_blank" class="img-option-link"><div><i class="fa fa-eye" style="color:yellow"></i></div></a>'
                                  html+='<a href="javascript:void(0)" onclick=\"img_katakata('+res[i].id+');\" title="Kata - Kata" class="img-option-link"><div><i class="fa fa-pencil" style="color:green"></i></div></a>'
                                html+='</div>'
    ...
    img_katakata = function(id){
        getpopup('slider/katakata_edit',tokens,"popupedit",id)
    }
    ...
    img_hapus = function(id){
        ...
        function(){
            ...
            $.ajax({
                url       : base_url + 'slider/gambar_hapus',
                type      : "post",
                dataType  : 'json',
                data      : {id : id,
...
margin-bottom: 10px;
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Data Slider Web</span>
        </nav>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <span style="font-size:12px;color:gray">Ukuran Gambar Slide yang disarankan : 1920 x 760</span>
