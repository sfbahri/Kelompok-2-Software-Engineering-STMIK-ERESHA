...
<!--                                <a href="" class="tx-danger mg-r-5"><i class="fa fa-file-o"></i></a>-->
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label for="comment">Alamat Pengiriman Koper & Paspor (Jika Ingin dikirim Koper dan Paspor)</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-info" id="btn_simpan"><i class="fa fa-save"></i> Update Biodata dan Dokumen</button>
                </div>
