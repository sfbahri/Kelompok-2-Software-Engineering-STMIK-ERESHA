...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data.pendidikan_terakhir == '' || data.pendidikan_terakhir == null){
                $("#pendidikan").val(0);
            }else{
                $("#pendidikan").val(data.pendidikan_terakhir);
            }
            
            if(data.warga_negara == '' || data.warga_negara == null){
                $("#warga_negara").val(0);
            }else{
...
<!--                                <a href="" class="tx-danger mg-r-5"><i class="fa fa-file-o"></i></a>-->
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                <label for="demo-vs-definput" class="control-label">Nomor KTP</label>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="status">
                        ...
                        <option value="5"> Cerai Hidup </option>
