          ...
          <div class="row"> 
            ...
            <div class="col-md-6">
                ...
                <label for="demo-vs-definput" class="control-label">Nama Lengkap (PASPOR)</label>
                    <input type="text" id="nama_paspor" name="nama_paspor" class="form-control uppercase">
                </div>
                ...
                <div class="form-group">
                <label for="demo-vs-definput" class="control-label">Nomor KK</label>
                ...
                <div class="form-group">
                <label for="demo-vs-definput" class="control-label">Nomor HP</label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="ambil_koper" name="ambil_koper">
                            ...
                            <option value="2"> Diambil di Rumah Om Ikhsan </option>
