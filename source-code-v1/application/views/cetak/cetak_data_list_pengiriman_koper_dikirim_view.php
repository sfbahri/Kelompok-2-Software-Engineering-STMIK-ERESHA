...
<th width="20px">No</th>
<th>Nama Jamaah</th>
<th width="20px">Nomor HP/ Telp</th>
<th width="50px">Bayar Pernak-Pernik</th>
<th width="50px">STATUS</th>
<th width="300px">ALAMAT PENGIRIMAN</th>
</tr>
</thead>
<tbody>
<?php 
...
<tr>
<td><?php echo $nos;?></td>
<td width="200px"><?php echo $a['nama'];?></td>
<td width="20px"><?php echo $a['no_telp'];?></td>
<?php 
    if($a['bayar_pernakpernik'] == 0){
      echo "<td align='center' width='20px' style='background-color:red;color:white;border-;'>BELUM BAYAR</td>";
    }else{
      echo "<td align='center' width='20px' style='background-color:green;color:white'>SUDAH BAYAR</td> ";
    }
?>
<?php if($a['koper'] == 0){
    echo "<td width='50px' style='background:gray;color:white'>Belum Pilih</td>";
}else if($a['koper'] == 1){
