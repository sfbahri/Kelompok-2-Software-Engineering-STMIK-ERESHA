        ...
        function(){
            ...
            $.ajax({
                ...
                if(response == true){
                        $('#'+id_modal).modal('hide');   
                        swal.close();
                        Command: toastr["success"]("Data Kloter berhasil disimpan", "Berhasil");
  ...
  <div class="modal-dialog"> 
    ...
    <div class="modal-content">
        <div class="modal-header pd-y-20 pd-x-25">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Tambah Kloter</h6>
